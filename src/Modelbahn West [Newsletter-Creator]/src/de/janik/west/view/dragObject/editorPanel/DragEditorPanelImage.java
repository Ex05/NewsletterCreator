 ...
 *
 */
public final class DragEditorPanelImage extends DragEditorPanel
{
	// <- Public ->
	// <- Protected ->
	...
	// <- Constructor ->
	public DragEditorPanelImage(final DragObjectPanelListener listener)
	{
		super(listener);
		...
		add(labelImage, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, CENTER, BOTH, new Insets(0, 0, 0, 0), 0, 0));
	}
	...
	private class PopUpImage extends InternalView
	{
		private static final long	serialVersionUID	= 1L;
		...
		public PopUpImage()
		{
			super("PopUp-Image", 400, 300, listener);

			panel = new JPanel();
			panel.setLayout(new GridBagLayout());

			labelImage = new JLabel(DragEditorPanelImage.this.labelImage.getIcon());
			...
			buttonSave.addActionListener(e -> {
				DragEditorPanelImage.this.labelImage.setIcon(labelImage.getIcon());
			...
			panel.add(searchBarURL, new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, CENTER, HORIZONTAL, new Insets(0, 4, 4, 4), 0, 0));
